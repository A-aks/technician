    ...
    return (
        <div className='container mt-3 gap-2 d-flex flex-column'>
            <Card style={{ width: 'auto' }}>
                <Card.Body>
                    <Card.Title>Get your AC Mounted</Card.Title>
                    <Card.Text>
                        AC mounting involves securely installing the air conditioning unit in a suitable location. This ensures proper stability and functionality of the AC system. It typically includes attaching the unit to a wall or placing it on a stable platform, connecting the necessary electrical and plumbing components, and ensuring proper ventilation for efficient cooling.
                        <div className='d-flex gap-4 w-50 flex-wrap my-2'>
                            <div className='d-flex align-items-center gap-2' style={{ color: "GrayText" }}>
                                ...
                                </svg><li className='d-inline text-decoration-none'>Get Full AC Intallation</li>
                            </div>
                            <div className='d-flex align-items-center gap-2' style={{ color: "GrayText" }}>
                                ...
                                </svg><li className='d-inline text-decoration-none'>Secure Installation</li>
                            </div>
                            <div className='d-flex align-items-center gap-2' style={{ color: "GrayText" }}>
                    ...
                    <Link to={'/BookService'}>
                        <Button variant="primary" style={{ backgroundColor: "#DBA800", border: "none", color: "white" }}>Contact technician</Button></Link>
                </Card.Body>
            </Card>
            <Card style={{ width: 'auto' }}>
                <Card.Body>
                    <Card.Title>Get your AC Unmouted</Card.Title>
                    <Card.Text>
                        AC mounting involves securely installing the air conditioning unit in a suitable location. This ensures proper stability and functionality of the AC system. It typically includes attaching the unit to a wall or placing it on a stable platform, connecting the necessary electrical and plumbing components, and ensuring proper ventilation for efficient cooling.
                        <div className='d-flex gap-4 w-50 flex-wrap my-2'>
                            <div className='d-flex align-items-center gap-2' style={{ color: "GrayText" }}>
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-plugin" viewBox="0 0 16 16">
                                    <path fill-rule="evenodd" d="M1 8a7 7 0 1 1 2.898 5.673c-.167-.121-.216-.406-.002-.62l1.8-1.8a3.5 3.5 0 0 0 4.572-.328l1.414-1.415a.5.5 0 0 0 0-.707l-.707-.707 1.559-1.563a.5.5 0 1 0-.708-.706l-1.559 1.562-1.414-1.414 1.56-1.562a.5.5 0 1 0-.707-.706l-1.56 1.56-.707-.706a.5.5 0 0 0-.707 0L5.318 5.975a3.5 3.5 0 0 0-.328 4.571l-1.8 1.8c-.58.58-.62 1.6.121 2.137A8 8 0 1 0 0 8a.5.5 0 0 0 1 0" />
                                </svg><li className='d-inline text-decoration-none'>Get Full AC Unmout</li>
                            </div>
                            <div className='d-flex align-items-center gap-2' style={{ color: "GrayText" }}>
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-shield-shaded" viewBox="0 0 16 16">
                                    <path fill-rule="evenodd" d="M8 14.933a1 1 0 0 0 .1-.025q.114-.034.294-.118c.24-.113.547-.29.893-.533a10.7 10.7 0 0 0 2.287-2.233c1.527-1.997 2.807-5.031 2.253-9.188a.48.48 0 0 0-.328-.39c-.651-.213-1.75-.56-2.837-.855C9.552 1.29 8.531 1.067 8 1.067zM5.072.56C6.157.265 7.31 0 8 0s1.843.265 2.928.56c1.11.3 2.229.655 2.887.87a1.54 1.54 0 0 1 1.044 1.262c.596 4.477-.787 7.795-2.465 9.99a11.8 11.8 0 0 1-2.517 2.453 7 7 0 0 1-1.048.625c-.28.132-.581.24-.829.24s-.548-.108-.829-.24a7 7 0 0 1-1.048-.625 11.8 11.8 0 0 1-2.517-2.453C1.928 10.487.545 7.169 1.141 2.692A1.54 1.54 0 0 1 2.185 1.43 63 63 0 0 1 5.072.56" />
                                </svg><li className='d-inline text-decoration-none'>Secure Removal</li>
                            </div>
                            <div className='d-flex align-items-center gap-2' style={{ color: "GrayText" }}>
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-cash-coin" viewBox="0 0 16 16">
                                    <path fill-rule="evenodd" d="M11 15a4 4 0 1 0 0-8 4 4 0 0 0 0 8m5-4a5 5 0 1 1-10 0 5 5 0 0 1 10 0" />
            ...
            <Card style={{ width: 'auto' }}>
                <Card.Body>
                    ...
                    <Card.Text>
                        Engaging a skilled technician for AC repairs ensures thorough diagnostics and precise solutions, optimizing your system's performance and longevity. Coupled with quality products, such as genuine replacement parts and efficient refrigerants, your AC receives the care it deserves, enhancing its reliability and energy efficiency. Entrusting your AC to capable hands and utilizing superior materials guarantee a comfortable and sustainable indoor climate for years to come.
                        ...
                        <div>
                            <ul>
                                {AC_repairs.AC_Repairs.map((repair, index) => (
