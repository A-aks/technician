        ...
        <Col xs={12} md={6}> {/* Set xs={12} to make it full width on mobile */}
          ...
          <Form onSubmit={handleSubmit}>
            <Form.Group controlId="formBasicPhoneNumber">
              <Form.Label className="custom-label my-2" style={{ color: '#333', fontWeight: 'bold' }}>Phone Number</Form.Label>
            ...
            <Form.Group controlId="formBasicPassword">
              <Form.Label className="custom-label my-2" style={{ color: '#333', fontWeight: 'bold' }}>Password</Form.Label>
